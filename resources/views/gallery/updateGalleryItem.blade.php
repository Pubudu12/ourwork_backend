    ...
    <div class="container-fluid">
        <div class="page-header">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card add" id="card_update">
                            <div class="card-body ">
                                <div class="product-adding">
                                    <div class="col-xl-12 cbody">
                                        <div class="add-product">
                                            <div class="row ">
                                                <form class="form add-product-form" data-action-after=2 data-redirect-url="" method="POST" action="/gallery/update" enctype="multipart/form-data">
                                                    @csrf
                                                                    ...
                                                                    <select class="form-control select2" name="upload_type" id="upload_type" onchange="changeDesign()">
                                                                        ...
                                                                        @else
                                                                            @if($data->item_type == "image")
                                                                                <option value="image" selected><h4><b>Image</b></h4></option>
                                                                                <option value="video"><h4><b>Video</b></h4></option> 
                                                                            @else
                                                                                <option value="image"><h4><b>Image</b></h4></option>
                                                                                <option value="video" selected><h4><b>Video</b></h4></option>
                                                                            @endif
                                                                        @endif 
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="form-group image-sec" id="image_section">
                                                            <div class="row justify-content-center row-md" id="img_sec">
                                                                ...
                                                                <div class="file-upload">
                                                                    ...
                                                                    <input type="file" name="file" class="file-upload hide" id="pack_img_upload" onchange="previewFile(this)">
                                                                    <img src="/uploads/gallery/{{ $data->image }}" id="preview_image" style="max-width:1200px;" class="previews"/>
                                                                </div>
                                                            </div>
                                                            <div class="row justify-content-center">
                                                                <div class="col-md">
                                                                    ...
                                                                    @else
                                                                        <textarea value="{{$data->text}}"  class="text-sec" type="text" class="form-control" name="text" id="linkName" placeholder="Write something" class="preview">{{$data->text}}</textarea>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <select class="form-control select2" name="video_type" id="video_type" onchange="changeDesign()">
                                                                        ...
                                                                        @else
                                                                            @if($data->video_type == "Youtube")
                                                                                <option value="Youtube" selected><h4><b>Youtube</b></h4></option>
                                                                                <option value="vimeo"><h4><b>vimeo</b></h4></option> 
                                                                            @else
                                                                                <option value="Youtube"><h4><b>Youtube</b></h4></option>
                                                                                <option value="vimeo" selected><h4><b>vimeo</b></h4></option>
                                                                            @endif
                                                                        @endif 
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="form-group form-label-group row">
                                                                <div class="col-sm-12 link">
                                                                    <div class="input-link">
                                                                        <input value="{{$data->video}}" type="text" class="form-text" name="link" id="linkName" placeholder="Link" class="preview" src="">
                                                                    </div>
                                                                </div>       
                                                            </div>
                                                        </div>
