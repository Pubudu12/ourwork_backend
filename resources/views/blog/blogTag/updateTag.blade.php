                ...
                <div class="card">
                    <div class="card-body">
                        <div class="product-adding">
                            ...
                            <form class="form add-product-form" data-action-after=2 data-redirect-url="" method="POST" action="/blog/updateTag">
                                @csrf
                                <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-lg-12 text-right">
                                            ...
                                            <br>
                                            <a href="/blog/tags" class="btn btn-transprent"> <i class="fa fa-chevron-left"></i> Back</a>
